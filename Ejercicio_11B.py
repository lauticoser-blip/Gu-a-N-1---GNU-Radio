...
class Ejercicio_11B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Ejercicio_11B")
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fcc(2, [1])
...
def main(top_block_cls=Ejercicio_11B, options=None):
