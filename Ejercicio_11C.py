...
class Ejercicio_11C(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Ejercicio_11C")
        ...
        self.blocks_wavfile_source_0_0 = blocks.wavfile_source('C:\\Users\\usuario\\Desktop\\ejer\\tono.wav', False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\usuario\\Desktop\\ejer\\tono.wav', False)
...
def main(top_block_cls=Ejercicio_11C, options=None):
