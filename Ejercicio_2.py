...
class Ejercicio_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Ejercicio_2")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(1000, analog.GR_COS_WAVE, 50, (-1), 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_c(1000, analog.GR_COS_WAVE, 250, 3, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(1000, analog.GR_COS_WAVE, 150, 10, 0, 0)
...
def main(top_block_cls=Ejercicio_2, options=None):
