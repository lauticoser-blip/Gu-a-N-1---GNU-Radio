...
class Ejercicio_5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Ejercicio_5")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(64000, analog.GR_SIN_WAVE, 1000, 1, 0, 0)
...
def main(top_block_cls=Ejercicio_5, options=None):
