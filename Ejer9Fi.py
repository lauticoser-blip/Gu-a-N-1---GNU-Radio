...
class Ejer9Fi(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Ejer9Fi")
        ...
        self.channels_quantizer_0 = channels.quantizer(4)
...
def main(top_block_cls=Ejer9Fi, options=None):
